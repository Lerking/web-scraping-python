...
def main():
    ...
    browser.get("https://www.sas.dk/book/flights/?search=RT_CPH-NYC-20230521-20230528_a1c0i0y0&view=upsell&bookingFlow=points&sortBy=rec,rec&filterBy=all,all&out_class=BUSINESS&out_sub_class=SAS%20BUSINESS%20PRO&out_flight_number=SK1462,SK907")
    #print(browser.page_source)
    offers = browser.find_elements(By.CLASS_NAME, 'product-row offers')
